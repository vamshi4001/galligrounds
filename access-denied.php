...
<body>
    ...
    <div class="container">
  		<div class="hero-unit">
  	    	<h1 align="center">Please Login to Continue</h1>
  			<p align="center">&nbsp;</p>
  			<h4 align="center" class="err">
  			 <!-- Please Register or Login to access this resource.<br/>-->
  			  <p><a style="width:120px;text-align:center;" class="btn primary large" href="register-form.php">Signin / Signup &raquo;</a></p>
